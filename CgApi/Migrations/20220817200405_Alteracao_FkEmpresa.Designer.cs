...
namespace CgApi.Migrations
{
    ...
    [Migration("20220817200405_Alteracao_FkEmpresa")]
    partial class Alteracao_FkEmpresa
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CgApi.Models.TbFluxoCaixa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CgApi.TbProjeto", b =>
                {
                    ...
                    b.Property<int?>("PrazoMedioFaturamento")
                        .HasColumnType("int");

                    b.Property<int?>("PrazoMedioRecebimento")
                        .HasColumnType("int");

                    b.Property<int?>("PrazoMedioVendas")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CgApi.Models.TbFluxoCaixa", b =>
                {
                    b.HasOne("CgApi.TbContasContabeis", "ContaContabil")
                        .WithMany("FluxoCaixa")
            ...
            modelBuilder.Entity("CgApi.TbContasContabeis", b =>
                {
                    ...
                    b.HasOne("CgApi.TbEmpresa", "TbEmpresa")
                        .WithOne("FkContasContabeisNavigation")
                        .HasForeignKey("CgApi.TbContasContabeis", "FkEmpresa")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
